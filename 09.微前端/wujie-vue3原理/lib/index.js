  ...
  (node, dir, context) => {
    ...
    return processFor(node, dir, context, (forNode) => {
      ...
      forNode.codegenNode = createVNodeCall(
        ...
        void 0,
        renderExp,
        fragmentFlag + (!!(process.env.NODE_ENV !== "production") ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__.PatchFlagNames[fragmentFlag]} */` : ``),
        void 0,
        void 0,
        true,
        !isStableFragment,
      ...
      return () => {
        ...
        if (slotOutlet) {
          ...
          childBlock = createVNodeCall(
            ...
            node.children,
            64 + (!!(process.env.NODE_ENV !== "production") ? ` /* ${_vue_shared__WEBPACK_IMPORTED_MODULE_0__.PatchFlagNames[64]} */` : ``),
            void 0,
            void 0,
            true,
            void 0,
...
/* harmony export */   destroyApp: () => (/* binding */ destroyApp),
/* harmony export */   preloadApp: () => (/* binding */ preloadApp),
...
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19);
/* harmony import */ var _sandbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(34);
/* harmony import */ var _shadow__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(38);
/* harmony import */ var _sync__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(50);
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(29);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(27);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(48);
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(52);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(28);
...
var bus = new _event__WEBPACK_IMPORTED_MODULE_10__.EventBus(Date.now().toString());
...
if (window.__WUJIE && !window.__POWERED_BY_WUJIE__) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_8__.stopMainAppRun)();
}

// 处理子应用链接跳转
(0,_sync__WEBPACK_IMPORTED_MODULE_6__.processAppForHrefJump)();

// 定义webComponent容器
(0,_shadow__WEBPACK_IMPORTED_MODULE_5__.defineWujieWebComponent)();

// 如果不支持则告警
if (!_utils__WEBPACK_IMPORTED_MODULE_8__.wujieSupport) (0,_utils__WEBPACK_IMPORTED_MODULE_8__.warn)(_constant__WEBPACK_IMPORTED_MODULE_11__.WUJIE_TIPS_NOT_SUPPORTED);

/**
 * 缓存子应用配置
 */
function setupApp(options) {
  if (options.name) (0,_common__WEBPACK_IMPORTED_MODULE_9__.addSandboxCacheWithOptions)(options.name, options);
}
 ...
 */
function _startApp() {
  _startApp = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(startOptions) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          sandbox = (0,_common__WEBPACK_IMPORTED_MODULE_9__.getWujieById)(startOptions.name);
          cacheOptions = (0,_common__WEBPACK_IMPORTED_MODULE_9__.getOptionsById)(startOptions.name); // 合并缓存配置
          options = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.mergeOptions)(startOptions, cacheOptions);
          ...
          sandbox.plugins = (0,_plugin__WEBPACK_IMPORTED_MODULE_7__.getPlugins)(plugins);
        ...
        case 14:
          ...
          _context2.next = 18;
          return (0,_entry__WEBPACK_IMPORTED_MODULE_3__["default"])({
            url: url,
            html: html,
            opts: {
        ...
        case 26:
          if (!(0,_utils__WEBPACK_IMPORTED_MODULE_8__.isFunction)(_iframeWindow.__WUJIE_MOUNT)) {
            _context2.next = 38;
            break;
          }
          /**
        ...
        case 39:
          // 设置loading
          (0,_shadow__WEBPACK_IMPORTED_MODULE_5__.addLoading)(el, loading);
          newSandbox = new _sandbox__WEBPACK_IMPORTED_MODULE_4__["default"]({
            name: name,
            url: url,
            attrs: attrs,
        ...
        case 44:
          ...
          _context2.next = 50;
          return (0,_entry__WEBPACK_IMPORTED_MODULE_3__.processCssLoader)(newSandbox, template, getExternalStyleSheets);
        case 50:
...
function preloadApp(preOptions) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_8__.requestIdleCallback)(function () {
    /**
     * 已经存在
     * url查询参数中有子应用的id，大概率是刷新浏览器或者分享url，此时需要直接打开子应用，无需预加载
     */
    if ((0,_common__WEBPACK_IMPORTED_MODULE_9__.getWujieById)(preOptions.name) || (0,_utils__WEBPACK_IMPORTED_MODULE_8__.isMatchSyncQueryById)(preOptions.name)) return;
    var cacheOptions = (0,_common__WEBPACK_IMPORTED_MODULE_9__.getOptionsById)(preOptions.name);
    // 合并缓存配置
    var options = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.mergeOptions)(_objectSpread({}, preOptions), cacheOptions);
    ...
    var sandbox = new _sandbox__WEBPACK_IMPORTED_MODULE_4__["default"]({
      name: name,
      url: url,
      attrs: attrs,
      degradeAttrs: degradeAttrs,
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _context.next = 9;
              return (0,_entry__WEBPACK_IMPORTED_MODULE_3__.processCssLoader)(sandbox, template, getExternalStyleSheets);
            case 9:
...
function destroyApp(id) {
  var sandbox = (0,_common__WEBPACK_IMPORTED_MODULE_9__.getWujieById)(id);
  if (sandbox) {
    sandbox.destroy();
  }
}
...
/* harmony export */ });
/* harmony import */ var _toPropertyKey_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
...
/* harmony export */ });
/* harmony import */ var _typeof_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var _toPrimitive_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);
...
/* harmony export */   processCssLoader: () => (/* binding */ processCssLoader)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28);
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29);
...
var embedHTMLCache = {};
if (!window.fetch) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_NO_FETCH);
  throw new Error();
}
...
function _processCssLoader() {
  _processCssLoader = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(sandbox, template, getExternalStyleSheets) {
    var curUrl, composeCssLoader, processedCssList, embedHTML;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          curUrl = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getCurUrl)(sandbox.proxyLocation);
          /** css-loader */
          composeCssLoader = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.compose)(sandbox.plugins.map(function (plugin) {
...
function _getEmbedHTML() {
  _getEmbedHTML = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2(template, styleResultList) {
    var embedHTML;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", Promise.all(styleResultList.map(function (styleResult, index) {
            return styleResult.contentPromise.then(function (content) {
              if (styleResult.src) {
                embedHTML = embedHTML.replace((0,_template__WEBPACK_IMPORTED_MODULE_3__.genLinkReplaceSymbol)(styleResult.src), styleResult.ignore ? "<link href=\"".concat(styleResult.src, "\" rel=\"stylesheet\" type=\"text/css\">") : "<style>/* ".concat(styleResult.src, " */").concat(content, "</style>"));
              } else if (content) {
                embedHTML = embedHTML.replace((0,_template__WEBPACK_IMPORTED_MODULE_3__.getInlineStyleReplaceSymbol)(index), "<style>/* inline-style-".concat(index, " */").concat(content, "</style>"));
              }
            });
          })).then(function () {
            return embedHTML;
...
var fetchAssets = function fetchAssets(src, cache, fetch, cssFlag, loadError) {
  return cache[src] || (cache[src] = fetch(src).then(function (response) {
    ...
    if (response.status >= 400) {
      cache[src] = null;
      if (cssFlag) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_CSS_ERROR_REQUESTED, {
          src: src,
          response: response
        });
        loadError === null || loadError === void 0 || loadError(src, new Error(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_CSS_ERROR_REQUESTED));
        return "";
      } else {
        (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_SCRIPT_ERROR_REQUESTED, {
          src: src,
          response: response
        });
        loadError === null || loadError === void 0 || loadError(src, new Error(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_SCRIPT_ERROR_REQUESTED));
        throw new Error(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_SCRIPT_ERROR_REQUESTED);
      }
    }
    ...
    cache[src] = null;
    if (cssFlag) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_CSS_ERROR_REQUESTED, src);
      loadError === null || loadError === void 0 || loadError(src, e);
      return "";
    } else {
      (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_SCRIPT_ERROR_REQUESTED, src);
      loadError === null || loadError === void 0 || loadError(src, e);
      return "";
    }
  }));
...
function _getExternalStyleSheets(styles) {
  ...
  return styles.map(function (_ref) {
    ...
    if (content) {
      ...
      return {
        src: "",
        contentPromise: Promise.resolve((0,_utils__WEBPACK_IMPORTED_MODULE_4__.getInlineCode)(src))
      };
    } else {
      // external styles
      return {
  ...
  return scripts.map(function (script) {
    ...
    if ((async || defer) && src && !module) {
      contentPromise = new Promise(function (resolve, reject) {
        return fiber ? (0,_utils__WEBPACK_IMPORTED_MODULE_4__.requestIdleCallback)(function () {
...
function importHTML(params) {
  ...
  var htmlLoader = plugins ? (0,_utils__WEBPACK_IMPORTED_MODULE_4__.compose)(plugins.map(function (plugin) {
    return plugin.htmlLoader;
  })) : defaultGetTemplate;
  var jsExcludes = (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.getEffectLoaders)("jsExcludes", plugins);
  var cssExcludes = (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.getEffectLoaders)("cssExcludes", plugins);
  var jsIgnores = (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.getEffectLoaders)("jsIgnores", plugins);
  var cssIgnores = (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.getEffectLoaders)("cssIgnores", plugins);
  var getPublicPath = _utils__WEBPACK_IMPORTED_MODULE_4__.defaultGetPublicPath;
  var getHtmlParseResult = function getHtmlParseResult(url, html, htmlLoader) {
    return (html ? Promise.resolve(html) : fetch(url).then(function (response) {
      if (response.status >= 400) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_HTML_ERROR_REQUESTED, {
          url: url,
          response: response
        });
        loadError === null || loadError === void 0 || loadError(url, new Error(_constant__WEBPACK_IMPORTED_MODULE_5__.WUJIE_TIPS_HTML_ERROR_REQUESTED));
        return "";
      }
      return response.text();
    })["catch"](function (e) {
      ...
      var _processTpl = (0,_template__WEBPACK_IMPORTED_MODULE_3__["default"])(htmlLoader(html), assetPublicPath),
      ...
      return {
        ...
        getExternalScripts: function getExternalScripts() {
          return _getExternalScripts(scripts.filter(function (script) {
            return !script.src || !(0,_plugin__WEBPACK_IMPORTED_MODULE_6__.isMatchUrl)(script.src, jsExcludes);
          }).map(function (script) {
            return _objectSpread(_objectSpread({}, script), {}, {
              ignore: script.src && (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.isMatchUrl)(script.src, jsIgnores)
            });
          }), fetch, loadError, fiber);
        },
        getExternalStyleSheets: function getExternalStyleSheets() {
          return _getExternalStyleSheets(styles.filter(function (style) {
            return !style.src || !(0,_plugin__WEBPACK_IMPORTED_MODULE_6__.isMatchUrl)(style.src, cssExcludes);
          }).map(function (style) {
            return _objectSpread(_objectSpread({}, style), {}, {
              ignore: style.src && (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.isMatchUrl)(style.src, cssIgnores)
            });
          }), fetch, loadError);
        }
      };
...
/* harmony export */   getInlineStyleReplaceSymbol: () => (/* binding */ getInlineStyleReplaceSymbol),
/* harmony export */   inlineScriptReplaceSymbol: () => (/* binding */ inlineScriptReplaceSymbol),
/* harmony export */   parseTagAttributes: () => (/* binding */ parseTagAttributes)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27);
...
/* harmony export */ });
/* harmony import */ var _arrayWithHoles_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
/* harmony import */ var _iterableToArrayLimit_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(23);
/* harmony import */ var _unsupportedIterableToArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
/* harmony import */ var _nonIterableRest_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26);
...
/* harmony export */ });
/* harmony import */ var _arrayLikeToArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   anchorElementGenerator: () => (/* binding */ anchorElementGenerator),
/* harmony export */   appRouteParse: () => (/* binding */ appRouteParse),
/* harmony export */   checkProxyFunction: () => (/* binding */ checkProxyFunction),
...
/* harmony export */   execHooks: () => (/* binding */ execHooks),
/* harmony export */   fixElementCtrSrcOrHref: () => (/* binding */ fixElementCtrSrcOrHref),
/* harmony export */   getAbsolutePath: () => (/* binding */ getAbsolutePath),
/* harmony export */   getAnchorElementQueryMap: () => (/* binding */ getAnchorElementQueryMap),
/* harmony export */   getContainer: () => (/* binding */ getContainer),
/* harmony export */   getCurUrl: () => (/* binding */ getCurUrl),
/* harmony export */   getDegradeIframe: () => (/* binding */ getDegradeIframe),
/* harmony export */   getInlineCode: () => (/* binding */ getInlineCode),
/* harmony export */   getSyncUrl: () => (/* binding */ getSyncUrl),
/* harmony export */   getTagFromScript: () => (/* binding */ getTagFromScript),
...
/* harmony export */   isMatchSyncQueryById: () => (/* binding */ isMatchSyncQueryById),
/* harmony export */   isScriptElement: () => (/* binding */ isScriptElement),
/* harmony export */   mergeOptions: () => (/* binding */ mergeOptions),
/* harmony export */   nextTick: () => (/* binding */ nextTick),
/* harmony export */   requestIdleCallback: () => (/* binding */ requestIdleCallback),
/* harmony export */   setAttrsToElement: () => (/* binding */ setAttrsToElement),
/* harmony export */   setTagToScript: () => (/* binding */ setTagToScript),
/* harmony export */   stopMainAppRun: () => (/* binding */ stopMainAppRun),
/* harmony export */   toArray: () => (/* binding */ toArray),
/* harmony export */   warn: () => (/* binding */ warn),
/* harmony export */   wujieSupport: () => (/* binding */ wujieSupport)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28);
...
function getDegradeIframe(id) {
  return window.document.querySelector("iframe[".concat(_constant__WEBPACK_IMPORTED_MODULE_2__.WUJIE_APP_ID, "=\"").concat(id, "\"]"));
}
...
function appRouteParse(url) {
  if (!url) {
    error(_constant__WEBPACK_IMPORTED_MODULE_2__.WUJIE_TIPS_NO_URL);
    throw new Error();
  }
...
function getAnchorElementQueryMap(anchorElement) {
  ...
  queryList.forEach(function (query) {
    var _query$split = query.split("="),
      _query$split2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_query$split, 2),
      key = _query$split2[0],
...
function setTagToScript(element, tag) {
  if (isScriptElement(element)) {
    ...
    element.setAttribute(_constant__WEBPACK_IMPORTED_MODULE_2__.WUJIE_SCRIPT_ID, scriptTag);
  }
}
function getTagFromScript(element) {
  if (isScriptElement(element)) {
    return element.getAttribute(_constant__WEBPACK_IMPORTED_MODULE_2__.WUJIE_SCRIPT_ID);
  }
  return null;
}
...
function stopMainAppRun() {
  warn(_constant__WEBPACK_IMPORTED_MODULE_2__.WUJIE_TIPS_STOP_APP_DETAIL);
  throw new Error(_constant__WEBPACK_IMPORTED_MODULE_2__.WUJIE_TIPS_STOP_APP);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CONTAINER_OVERFLOW_DATA_FLAG: () => (/* binding */ CONTAINER_OVERFLOW_DATA_FLAG),
/* harmony export */   CONTAINER_POSITION_DATA_FLAG: () => (/* binding */ CONTAINER_POSITION_DATA_FLAG),
/* harmony export */   LOADING_DATA_FLAG: () => (/* binding */ LOADING_DATA_FLAG),
/* harmony export */   WUJIE_ALL_EVENT: () => (/* binding */ WUJIE_ALL_EVENT),
/* harmony export */   WUJIE_APP_ID: () => (/* binding */ WUJIE_APP_ID),
/* harmony export */   WUJIE_DATA_ATTACH_CSS_FLAG: () => (/* binding */ WUJIE_DATA_ATTACH_CSS_FLAG),
/* harmony export */   WUJIE_DATA_FLAG: () => (/* binding */ WUJIE_DATA_FLAG),
/* harmony export */   WUJIE_IFRAME_CLASS: () => (/* binding */ WUJIE_IFRAME_CLASS),
/* harmony export */   WUJIE_LOADING_STYLE: () => (/* binding */ WUJIE_LOADING_STYLE),
/* harmony export */   WUJIE_LOADING_SVG: () => (/* binding */ WUJIE_LOADING_SVG),
/* harmony export */   WUJIE_SCRIPT_ID: () => (/* binding */ WUJIE_SCRIPT_ID),
/* harmony export */   WUJIE_SHADE_STYLE: () => (/* binding */ WUJIE_SHADE_STYLE),
/* harmony export */   WUJIE_TIPS_CSS_ERROR_REQUESTED: () => (/* binding */ WUJIE_TIPS_CSS_ERROR_REQUESTED),
/* harmony export */   WUJIE_TIPS_GET_ELEMENT_BY_ID: () => (/* binding */ WUJIE_TIPS_GET_ELEMENT_BY_ID),
/* harmony export */   WUJIE_TIPS_HTML_ERROR_REQUESTED: () => (/* binding */ WUJIE_TIPS_HTML_ERROR_REQUESTED),
/* harmony export */   WUJIE_TIPS_NOT_SUPPORTED: () => (/* binding */ WUJIE_TIPS_NOT_SUPPORTED),
/* harmony export */   WUJIE_TIPS_NO_FETCH: () => (/* binding */ WUJIE_TIPS_NO_FETCH),
/* harmony export */   WUJIE_TIPS_NO_SCRIPT: () => (/* binding */ WUJIE_TIPS_NO_SCRIPT),
/* harmony export */   WUJIE_TIPS_NO_SUBJECT: () => (/* binding */ WUJIE_TIPS_NO_SUBJECT),
/* harmony export */   WUJIE_TIPS_NO_URL: () => (/* binding */ WUJIE_TIPS_NO_URL),
/* harmony export */   WUJIE_TIPS_RELOAD_DISABLED: () => (/* binding */ WUJIE_TIPS_RELOAD_DISABLED),
/* harmony export */   WUJIE_TIPS_REPEAT_RENDER: () => (/* binding */ WUJIE_TIPS_REPEAT_RENDER),
/* harmony export */   WUJIE_TIPS_SCRIPT_ERROR_REQUESTED: () => (/* binding */ WUJIE_TIPS_SCRIPT_ERROR_REQUESTED),
/* harmony export */   WUJIE_TIPS_STOP_APP: () => (/* binding */ WUJIE_TIPS_STOP_APP),
/* harmony export */   WUJIE_TIPS_STOP_APP_DETAIL: () => (/* binding */ WUJIE_TIPS_STOP_APP_DETAIL)
/* harmony export */ });
// 私有元素属性
...
/* harmony export */   getCssLoader: () => (/* binding */ getCssLoader),
/* harmony export */   getEffectLoaders: () => (/* binding */ getEffectLoaders),
/* harmony export */   getJsLoader: () => (/* binding */ getJsLoader),
/* harmony export */   getPlugins: () => (/* binding */ getPlugins),
/* harmony export */   getPresetLoaders: () => (/* binding */ getPresetLoaders),
...
function getCssLoader(_ref) {
  ...
  return function (code) {
    ...
    return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.compose)(plugins.map(function (plugin) {
      return plugin.cssLoader;
...
function cssRelativePathResolve(code, src, base) {
  var baseUrl = src ? (0,_utils__WEBPACK_IMPORTED_MODULE_1__.getAbsolutePath)(src, base) : base;
  // https://developer.mozilla.org/en-US/docs/Web/CSS/url
  var urlReg = /(url\((?!['"]?(?:data):)['"]?)([^'")]*)(['"]?\))/g;
  return code.replace(urlReg, function (_m, pre, url, post) {
    var absoluteUrl = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.getAbsolutePath)(url, baseUrl);
...
function getPlugins(plugins) {
  return Array.isArray(plugins) ? [defaultPlugin].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(plugins)) : [defaultPlugin];
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (defaultPlugin);
...
/* harmony export */ });
/* harmony import */ var _arrayWithoutHoles_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31);
/* harmony import */ var _iterableToArray_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(32);
/* harmony import */ var _unsupportedIterableToArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Wujie)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35);
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(36);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _iframe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(37);
/* harmony import */ var _sync__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(50);
/* harmony import */ var _shadow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(38);
/* harmony import */ var _proxy__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(51);
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(29);
/* harmony import */ var _effect__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(49);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(48);
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(52);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(27);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(28);
...
var Wujie = /*#__PURE__*/function () {
  ...
  function Wujie(options) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Wujie);
    /** 激活时路由地址 */
    /** 子应用保活 */
    /** window代理 */
    /** document代理 */
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4__["default"])(this, "elementEventCacheMap", new WeakMap());
    // 传递inject给嵌套子应用
    if (window.__POWERED_BY_WUJIE__) this.inject = window.__WUJIE.inject;else {
      this.inject = {
        idToSandboxMap: _common__WEBPACK_IMPORTED_MODULE_12__.idToSandboxCacheMap,
        appEventObjMap: _event__WEBPACK_IMPORTED_MODULE_13__.appEventObjMap,
    ...
    this.id = name;
    this.fiber = fiber;
    this.degrade = degrade || !_utils__WEBPACK_IMPORTED_MODULE_14__.wujieSupport;
    this.bus = new _event__WEBPACK_IMPORTED_MODULE_13__.EventBus(this.id);
    this.url = url;
    ...
    this.plugins = (0,_plugin__WEBPACK_IMPORTED_MODULE_10__.getPlugins)(plugins);

    // 创建目标地址的解析
    var _appRouteParse = (0,_utils__WEBPACK_IMPORTED_MODULE_14__.appRouteParse)(url),
    ...
    // 创建iframe
    this.iframe = (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.iframeGenerator)(this, attrs, mainHostPath, appHostPath, appRoutePath);
    if (this.degrade) {
      var _localGenerator = (0,_proxy__WEBPACK_IMPORTED_MODULE_9__.localGenerator)(this.iframe, urlElement, mainHostPath, appHostPath),
        proxyDocument = _localGenerator.proxyDocument,
        proxyLocation = _localGenerator.proxyLocation;
      this.proxyDocument = proxyDocument;
      this.proxyLocation = proxyLocation;
    } else {
      var _proxyGenerator = (0,_proxy__WEBPACK_IMPORTED_MODULE_9__.proxyGenerator)(this.iframe, urlElement, mainHostPath, appHostPath),
    ...
    (0,_common__WEBPACK_IMPORTED_MODULE_12__.addSandboxCacheWithWujie)(this.id, this);
  }
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Wujie, [{
    key: "active",
    value: (
    /** $wujie对象，提供给子应用的接口 */
     ...
     */
    function () {
      var _active = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee(options) {
        var _this = this;
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 11:
              ...
              iframeFetch = fetch ? function (input, init) {
                return fetch(typeof input === "string" ? (0,_utils__WEBPACK_IMPORTED_MODULE_14__.getAbsolutePath)(input, _this.proxyLocation.href) : input, init);
              } : this.fetch;
              if (iframeFetch) {
              ...
              if (this.execFlag && this.alive) {
                ...
                (0,_sync__WEBPACK_IMPORTED_MODULE_7__.syncUrlToWindow)(iframeWindow);
              } else {
                // 先将url同步回iframe，然后再同步回浏览器url
                (0,_sync__WEBPACK_IMPORTED_MODULE_7__.syncUrlToIframe)(iframeWindow);
                (0,_sync__WEBPACK_IMPORTED_MODULE_7__.syncUrlToWindow)(iframeWindow);
              }
              ...
              iframeBody = _common__WEBPACK_IMPORTED_MODULE_12__.rawDocumentQuerySelector.call(iframeWindow.document, "body");
              _initRenderIframeAndC = (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.initRenderIframeAndContainer)(this.id, el !== null && el !== void 0 ? el : iframeBody, this.degradeAttrs), iframe = _initRenderIframeAndC.iframe, container = _initRenderIframeAndC.container;
              this.el = container;
              // 销毁js运行iframe容器内部dom
              if (el) (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.clearChild)(iframeBody);
              // 修复vue的event.timeStamp问题
              (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.patchEventTimeStamp)(iframe.contentWindow, iframeWindow);
              ...
              // 保活场景需要事件全部恢复
              (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.recoverEventListeners)(iframe.contentDocument.documentElement, iframeWindow);
              _context.next = 32;
              break;
            case 29:
              _context.next = 31;
              return (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.renderTemplateToIframe)(iframe.contentDocument, this.iframe.contentWindow, this.template);
            case 31:
              // 非保活场景需要恢复根节点的事件，防止react16监听事件丢失
              (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.recoverDocumentListeners)(this.document.documentElement, iframe.contentDocument.documentElement, iframeWindow);
            case 32:
              _context.next = 36;
              break;
            case 34:
            ...
            case 38:
               ...
               */
              this.el = (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.renderElementToContainer)(this.shadowRoot.host, el);
              if (!this.alive) {
                _context.next = 42;
                break;
              }
            ...
            case 44:
              ...
              _iframeBody = _common__WEBPACK_IMPORTED_MODULE_12__.rawDocumentQuerySelector.call(iframeWindow.document, "body");
              this.el = (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.renderElementToContainer)((0,_shadow__WEBPACK_IMPORTED_MODULE_8__.createWujieWebComponent)(this.id), el !== null && el !== void 0 ? el : _iframeBody);
            case 46:
              _context.next = 48;
              return (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.renderTemplateToShadowRoot)(this.shadowRoot, iframeWindow, this.template);
            case 48:
              this.patchCssRules();
    ...
    value: function requestIdleCallback(callback) {
      var _this2 = this;
      return (0,_utils__WEBPACK_IMPORTED_MODULE_14__.requestIdleCallback)(function () {
        // 假如已经被销毁了
    ...
    key: "start",
    value: (function () {
      var _start = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().mark(function _callee2(getExternalScripts) {
        var _this3 = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_5___default().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              // 用户自定义代码前
              beforeScriptResultList = (0,_plugin__WEBPACK_IMPORTED_MODULE_10__.getPresetLoaders)("jsBeforeLoaders", this.plugins); // 用户自定义代码后
              afterScriptResultList = (0,_plugin__WEBPACK_IMPORTED_MODULE_10__.getPresetLoaders)("jsAfterLoaders", this.plugins); // 同步代码
              ...
              beforeScriptResultList.forEach(function (beforeScriptResult) {
                _this3.execQueue.push(function () {
                  return _this3.fiber ? _this3.requestIdleCallback(function () {
                    return (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)(beforeScriptResult, iframeWindow);
                  }) : (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)(beforeScriptResult, iframeWindow);
                });
              });
              ...
              syncScriptResultList.concat(deferScriptResultList).forEach(function (scriptResult) {
                _this3.execQueue.push(function () {
                  return scriptResult.contentPromise.then(function (content) {
                    return _this3.fiber ? _this3.requestIdleCallback(function () {
                      return (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)(_objectSpread(_objectSpread({}, scriptResult), {}, {
                        content: content
                      }), iframeWindow);
                    }) : (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)(_objectSpread(_objectSpread({}, scriptResult), {}, {
                      content: content
                    }), iframeWindow);
                  });
                });
              ...
              domContentLoadedTrigger = function domContentLoadedTrigger() {
                ...
                (0,_utils__WEBPACK_IMPORTED_MODULE_14__.eventTrigger)(iframeWindow.document, "DOMContentLoaded");
                (0,_utils__WEBPACK_IMPORTED_MODULE_14__.eventTrigger)(iframeWindow, "DOMContentLoaded");
              ...
              afterScriptResultList.forEach(function (afterScriptResult) {
                _this3.execQueue.push(function () {
                  return _this3.fiber ? _this3.requestIdleCallback(function () {
                    return (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)(afterScriptResult, iframeWindow);
                  }) : (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)(afterScriptResult, iframeWindow);
                });
              });
              ...
              domLoadedTrigger = function domLoadedTrigger() {
                ...
                (0,_utils__WEBPACK_IMPORTED_MODULE_14__.eventTrigger)(iframeWindow.document, "readystatechange");
                (0,_utils__WEBPACK_IMPORTED_MODULE_14__.eventTrigger)(iframeWindow, "load");
              ...
              if (this.alive || !(0,_utils__WEBPACK_IMPORTED_MODULE_14__.isFunction)(this.iframe.contentWindow.__WUJIE_UNMOUNT)) (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.removeLoading)(this.el);
    ...
    value: function mount() {
      ...
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_14__.isFunction)(this.iframe.contentWindow.__WUJIE_MOUNT)) {
        var _this$lifecycles, _this$lifecycles$befo, _this$lifecycles2, _this$lifecycles2$aft;
        (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.removeLoading)(this.el);
    ...
    value: function unmount() {
      ...
      // 清理子应用过期的同步参数
      (0,_sync__WEBPACK_IMPORTED_MODULE_7__.clearInactiveAppUrl)();
      if (this.alive) {
      ...
      if (!this.mountFlag) return;
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_14__.isFunction)(this.iframe.contentWindow.__WUJIE_UNMOUNT) && !this.alive && !this.hrefFlag) {
        ...
        this.bus.$clear();
        if (!this.degrade) {
          (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.clearChild)(this.shadowRoot);
          // head body需要复用，每次都要清空事件
          (0,_effect__WEBPACK_IMPORTED_MODULE_11__.removeEventListener)(this.head);
          (0,_effect__WEBPACK_IMPORTED_MODULE_11__.removeEventListener)(this.body);
        }
        (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.clearChild)(this.head);
        (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.clearChild)(this.body);
      }
    }
    ...
    value: function destroy() {
      ...
      // 清除 dom
      if (this.el) {
        (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.clearChild)(this.el);
        this.el = null;
      }
      // 清除 iframe 沙箱
      if (this.iframe) {
      ...
      (0,_common__WEBPACK_IMPORTED_MODULE_12__.deleteWujieById)(this.id);
    }
    ...
    value: function rebuildStyleSheets() {
      ...
      if (this.styleSheetElements && this.styleSheetElements.length) {
        this.styleSheetElements.forEach(function (styleSheetElement) {
          _common__WEBPACK_IMPORTED_MODULE_12__.rawElementAppendChild.call(_this4.degrade ? _this4.document.head : _this4.shadowRoot.head, styleSheetElement);
        });
      }
      this.patchCssRules();
    }
    ...
    value: function patchCssRules() {
      ...
      if (this.shadowRoot.host.hasAttribute(_constant__WEBPACK_IMPORTED_MODULE_15__.WUJIE_DATA_ATTACH_CSS_FLAG)) return;
      var _getPatchStyleElement = (0,_shadow__WEBPACK_IMPORTED_MODULE_8__.getPatchStyleElements)(Array.from(this.iframe.contentDocument.querySelectorAll("style")).map(function (styleSheetElement) {
          return styleSheetElement.sheet;
        })),
        _getPatchStyleElement2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_getPatchStyleElement, 2),
      ...
      (hostStyleSheetElement || fontStyleSheetElement) && this.shadowRoot.host.setAttribute(_constant__WEBPACK_IMPORTED_MODULE_15__.WUJIE_DATA_ATTACH_CSS_FLAG, "");
    }
  }]);
  return Wujie;
}();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   iframeGenerator: () => (/* binding */ iframeGenerator),
/* harmony export */   initBase: () => (/* binding */ initBase),
/* harmony export */   insertScriptToIframe: () => (/* binding */ insertScriptToIframe),
/* harmony export */   patchElementEffect: () => (/* binding */ patchElementEffect),
/* harmony export */   patchEventTimeStamp: () => (/* binding */ patchEventTimeStamp),
/* harmony export */   recoverDocumentListeners: () => (/* binding */ recoverDocumentListeners),
/* harmony export */   recoverEventListeners: () => (/* binding */ recoverEventListeners),
/* harmony export */   renderIframeReplaceApp: () => (/* binding */ renderIframeReplaceApp),
/* harmony export */   syncIframeUrlToWindow: () => (/* binding */ syncIframeUrlToWindow)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
/* harmony import */ var _shadow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(38);
/* harmony import */ var _sync__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(50);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(48);
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28);
...
function patchIframeEvents(iframeWindow) {
  ...
  iframeWindow.addEventListener = function addEventListener(type, listener, options) {
    // 运行插件钩子函数
    (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "windowAddEventListenerHook", iframeWindow, type, listener, options);
    ...
    if (_common__WEBPACK_IMPORTED_MODULE_5__.appWindowAddEventListenerEvents.includes(type) || (0,_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1__["default"])(options) === "object" && options.targetWindow) {
      var targetWindow = (0,_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1__["default"])(options) === "object" && options.targetWindow ? options === null || options === void 0 ? void 0 : options.targetWindow : iframeWindow;
      return _common__WEBPACK_IMPORTED_MODULE_5__.rawWindowAddEventListener.call(targetWindow, type, listener, options);
    }
    // 在子应用嵌套场景使用window.window获取真实window
    _common__WEBPACK_IMPORTED_MODULE_5__.rawWindowAddEventListener.call(window.__WUJIE_RAW_WINDOW__ || window, type, listener, options);
  };
  iframeWindow.removeEventListener = function removeEventListener(type, listener, options) {
    // 运行插件钩子函数
    (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "windowRemoveEventListenerHook", iframeWindow, type, listener, options);
    ...
    if (_common__WEBPACK_IMPORTED_MODULE_5__.appWindowAddEventListenerEvents.includes(type) || (0,_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1__["default"])(options) === "object" && options.targetWindow) {
      var targetWindow = (0,_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_1__["default"])(options) === "object" && options.targetWindow ? options === null || options === void 0 ? void 0 : options.targetWindow : iframeWindow;
      return _common__WEBPACK_IMPORTED_MODULE_5__.rawWindowRemoveEventListener.call(targetWindow, type, listener, options);
    }
    _common__WEBPACK_IMPORTED_MODULE_5__.rawWindowRemoveEventListener.call(window.__WUJIE_RAW_WINDOW__ || window, type, listener, options);
  };
}
...
function patchIframeHistory(iframeWindow, appHostPath, mainHostPath) {
  ...
  history.pushState = function (data, title, url) {
    ...
    var mainUrl = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getAbsolutePath)(url === null || url === void 0 ? void 0 : url.replace(appHostPath, ""), baseUrl);
    ...
    (0,_sync__WEBPACK_IMPORTED_MODULE_3__.syncUrlToWindow)(iframeWindow);
  };
...
function updateBase(iframeWindow, appHostPath, mainHostPath) {
  ...
  var baseElement = _common__WEBPACK_IMPORTED_MODULE_5__.rawDocumentQuerySelector.call(iframeWindow.document, "base");
...
function patchWindowEffect(iframeWindow) {
  ...
  function processWindowProperty(key) {
    ...
    try {
      if (typeof value === "function" && !(0,_utils__WEBPACK_IMPORTED_MODULE_4__.isConstructable)(value)) {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_4__.warn)(e.message);
      return false;
    }
  }
  Object.getOwnPropertyNames(iframeWindow).forEach(function (key) {
    ...
    // 单独属性
    if (_common__WEBPACK_IMPORTED_MODULE_5__.windowProxyProperties.includes(key)) {
      processWindowProperty(key);
      return;
    }
    // 正则匹配，可以一次处理多个
    _common__WEBPACK_IMPORTED_MODULE_5__.windowRegWhiteList.some(function (reg) {
  ...
  var windowOnEvents = Object.getOwnPropertyNames(window).filter(function (p) {
    ...
    return !_common__WEBPACK_IMPORTED_MODULE_5__.appWindowOnEvent.includes(e);
  });
  ...
  // 运行插件钩子函数
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "windowPropertyOverride", iframeWindow);
}
...
function recordEventListeners(iframeWindow) {
  ...
  iframeWindow.Node.prototype.addEventListener = function (type, handler, options) {
    ...
    return _common__WEBPACK_IMPORTED_MODULE_5__.rawAddEventListener.call(this, type, handler, options);
  };
  iframeWindow.Node.prototype.removeEventListener = function (type, handler, options) {
    ...
    return _common__WEBPACK_IMPORTED_MODULE_5__.rawRemoveEventListener.call(this, type, handler, options);
  };
}
...
function patchDocumentEffect(iframeWindow) {
  ...
  iframeWindow.Document.prototype.addEventListener = function (type, handler, options) {
    ...
    // 运行插件钩子函数
    (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "documentAddEventListenerHook", iframeWindow, type, callback, options);
    if (_common__WEBPACK_IMPORTED_MODULE_5__.appDocumentAddEventListenerEvents.includes(type)) {
      return _common__WEBPACK_IMPORTED_MODULE_5__.rawAddEventListener.call(this, type, callback, options);
    }
    // 降级统一走 sandbox.document
    if (sandbox.degrade) return sandbox.document.addEventListener(type, callback, options);
    if (_common__WEBPACK_IMPORTED_MODULE_5__.mainDocumentAddEventListenerEvents.includes(type)) return window.document.addEventListener(type, callback, options);
    if (_common__WEBPACK_IMPORTED_MODULE_5__.mainAndAppAddEventListenerEvents.includes(type)) {
  ...
  iframeWindow.Document.prototype.removeEventListener = function (type, handler, options) {
    ...
    if (callback) {
      ...
      // 运行插件钩子函数
      (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "documentRemoveEventListenerHook", iframeWindow, type, callback, options);
      if (_common__WEBPACK_IMPORTED_MODULE_5__.appDocumentAddEventListenerEvents.includes(type)) {
        return _common__WEBPACK_IMPORTED_MODULE_5__.rawRemoveEventListener.call(this, type, callback, options);
      }
      if (sandbox.degrade) return sandbox.document.removeEventListener(type, callback, options);
      if (_common__WEBPACK_IMPORTED_MODULE_5__.mainDocumentAddEventListenerEvents.includes(type)) {
  ...
  var documentOnEvent = Object.keys(iframeWindow.Document.prototype).filter(function (ele) {
    ...
    return !_common__WEBPACK_IMPORTED_MODULE_5__.appDocumentOnEvents.includes(ele);
  });
  ...
  // 处理属性get
  var ownerProperties = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.ownerProperties,
    modifyProperties = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.modifyProperties,
    shadowProperties = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.shadowProperties,
    shadowMethods = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.shadowMethods,
    documentProperties = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.documentProperties,
    documentMethods = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.documentMethods,
    documentEvents = _common__WEBPACK_IMPORTED_MODULE_5__.documentProxyProperties.documentEvents;
  ...
  // 运行插件钩子函数
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "documentPropertyOverride", iframeWindow);
}
...
function patchRelativeUrlEffect(iframeWindow) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.fixElementCtrSrcOrHref)(iframeWindow, iframeWindow.HTMLImageElement, "src");
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.fixElementCtrSrcOrHref)(iframeWindow, iframeWindow.HTMLAnchorElement, "href");
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.fixElementCtrSrcOrHref)(iframeWindow, iframeWindow.HTMLSourceElement, "src");
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.fixElementCtrSrcOrHref)(iframeWindow, iframeWindow.HTMLLinkElement, "href");
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.fixElementCtrSrcOrHref)(iframeWindow, iframeWindow.HTMLScriptElement, "src");
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.fixElementCtrSrcOrHref)(iframeWindow, iframeWindow.HTMLMediaElement, "src");
}
...
function initBase(iframeWindow, url) {
  ...
  var iframeUrlElement = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.anchorElementGenerator)(iframeWindow.location.href);
  var appUrlElement = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.anchorElementGenerator)(url);
...
function patchElementEffect(element, iframeWindow) {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(iframeWindow.__WUJIE.plugins, "patchElementHook", element, iframeWindow);
}
...
function syncIframeUrlToWindow(iframeWindow) {
  iframeWindow.addEventListener("hashchange", function () {
    return (0,_sync__WEBPACK_IMPORTED_MODULE_3__.syncUrlToWindow)(iframeWindow);
  });
...
function insertScriptToIframe(scriptResult, iframeWindow, rawElement) {
  ...
  var jsLoader = (0,_plugin__WEBPACK_IMPORTED_MODULE_6__.getJsLoader)({
    plugins: plugins,
    replace: replace
  });
  var code = jsLoader(content, src, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getCurUrl)(proxyLocation));
  // 添加属性
  ...
  var container = _common__WEBPACK_IMPORTED_MODULE_5__.rawDocumentQuerySelector.call(iframeWindow.document, "head");
  ...
  if (/^<!DOCTYPE html/i.test(code)) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_4__.error)(_constant__WEBPACK_IMPORTED_MODULE_7__.WUJIE_TIPS_SCRIPT_ERROR_REQUESTED, scriptResult);
    return execNextScript();
  }

  // 打标记
  if (rawElement) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_4__.setTagToScript)(scriptElement, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getTagFromScript)(rawElement));
  }
  // 外联脚本执行后的处理
  ...
  // 执行 hooks
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.execHooks)(plugins, "appendOrInsertElementHook", scriptElement, iframeWindow, rawElement);
  // 内联脚本执行后的处理
...
function renderIframeReplaceApp(src, element) {
  ...
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.setAttrsToElement)(iframe, _objectSpread(_objectSpread({}, degradeAttrs), {}, {
    src: src,
    style: [defaultStyle, degradeAttrs.style].join(";")
  }));
  (0,_shadow__WEBPACK_IMPORTED_MODULE_2__.renderElementToContainer)(iframe, element);
}
...
function iframeGenerator(sandbox, attrs, mainHostPath, appHostPath, appRoutePath) {
  ...
  var attrsMerge = _objectSpread(_objectSpread({
    src: mainHostPath,
    style: "display: none"
  }, attrs), {}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
    name: sandbox.id
  }, _constant__WEBPACK_IMPORTED_MODULE_7__.WUJIE_DATA_FLAG, ""));
  (0,_utils__WEBPACK_IMPORTED_MODULE_4__.setAttrsToElement)(iframe, attrsMerge);
  ...
  sandbox.iframeReady = stopIframeLoading(iframeWindow).then(function () {
     ...
     * 如果有同步优先同步，非同步从url读取
     */
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_4__.isMatchSyncQueryById)(iframeWindow.__WUJIE.id)) {
...
/* harmony export */   createIframeContainer: () => (/* binding */ createIframeContainer),
/* harmony export */   createWujieWebComponent: () => (/* binding */ createWujieWebComponent),
/* harmony export */   defineWujieWebComponent: () => (/* binding */ defineWujieWebComponent),
/* harmony export */   getPatchStyleElements: () => (/* binding */ getPatchStyleElements),
/* harmony export */   initRenderIframeAndContainer: () => (/* binding */ initRenderIframeAndContainer),
/* harmony export */   removeLoading: () => (/* binding */ removeLoading),
/* harmony export */   renderElementToContainer: () => (/* binding */ renderElementToContainer),
/* harmony export */   renderTemplateToIframe: () => (/* binding */ renderTemplateToIframe),
/* harmony export */   renderTemplateToShadowRoot: () => (/* binding */ renderTemplateToShadowRoot)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35);
...
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(41);
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43);
/* harmony import */ var _babel_runtime_helpers_wrapNativeSuper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(44);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(28);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(48);
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(19);
/* harmony import */ var _iframe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(37);
/* harmony import */ var _effect__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(49);
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(29);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(27);
...
function defineWujieWebComponent() {
  ...
  if (customElements && !(customElements !== null && customElements !== void 0 && customElements.get("wujie-app"))) {
    var WujieApp = /*#__PURE__*/function (_HTMLElement) {
      (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(WujieApp, _HTMLElement);
      var _super = _createSuper(WujieApp);
      function WujieApp() {
        (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, WujieApp);
        return _super.apply(this, arguments);
      }
      (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(WujieApp, [{
        ...
        value: function connectedCallback() {
          ...
          var sandbox = (0,_common__WEBPACK_IMPORTED_MODULE_10__.getWujieById)(this.getAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_APP_ID));
          (0,_iframe__WEBPACK_IMPORTED_MODULE_12__.patchElementEffect)(shadowRoot, sandbox.iframe.contentWindow);
...
function createWujieWebComponent(id) {
  ...
  contentElement.setAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_APP_ID, id);
  contentElement.classList.add(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_IFRAME_CLASS);
...
function renderElementToContainer(element, selectorOrElement) {
  var container = (0,_utils__WEBPACK_IMPORTED_MODULE_15__.getContainer)(selectorOrElement);
  if (container && !container.contains(element)) {
    // 有 loading 无需清理，已经清理过了
    if (!container.querySelector("div[".concat(_constant__WEBPACK_IMPORTED_MODULE_9__.LOADING_DATA_FLAG, "]"))) {
      // 清除内容
      clearChild(container);
    }
    // 插入元素
    if (element) {
      _common__WEBPACK_IMPORTED_MODULE_10__.rawElementAppendChild.call(container, element);
    }
  }
  return container;
}
...
function _processCssLoaderForTemplate() {
  _processCssLoaderForTemplate = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().mark(function _callee(sandbox, html) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          cssLoader = (0,_plugin__WEBPACK_IMPORTED_MODULE_14__.getCssLoader)({
            plugins: plugins,
            replace: replace
          });
          cssBeforeLoaders = (0,_plugin__WEBPACK_IMPORTED_MODULE_14__.getPresetLoaders)("cssBeforeLoaders", plugins);
          cssAfterLoaders = (0,_plugin__WEBPACK_IMPORTED_MODULE_14__.getPresetLoaders)("cssAfterLoaders", plugins);
          curUrl = (0,_utils__WEBPACK_IMPORTED_MODULE_15__.getCurUrl)(proxyLocation);
          _context.next = 8;
          return Promise.all([Promise.all((0,_entry__WEBPACK_IMPORTED_MODULE_11__.getExternalStyleSheets)(cssBeforeLoaders, sandbox.fetch, sandbox.lifecycles.loadError).map(function (_ref) {
            var src = _ref.src,
          ...
          }), Promise.all((0,_entry__WEBPACK_IMPORTED_MODULE_11__.getExternalStyleSheets)(cssAfterLoaders, sandbox.fetch, sandbox.lifecycles.loadError).map(function (_ref3) {
            var src = _ref3.src,
...
function replaceHeadAndBody(html, head, body) {
  ...
  if (headElement) {
    while (headElement.firstChild) {
      _common__WEBPACK_IMPORTED_MODULE_10__.rawAppendChild.call(head, headElement.firstChild.cloneNode(true));
  ...
  if (bodyElement) {
    while (bodyElement.firstChild) {
      _common__WEBPACK_IMPORTED_MODULE_10__.rawAppendChild.call(body, bodyElement.firstChild.cloneNode(true));
...
function renderTemplateToHtml(iframeWindow, template) {
  ...
  var nextElement = ElementIterator.currentNode;
  while (nextElement) {
    (0,_iframe__WEBPACK_IMPORTED_MODULE_12__.patchElementEffect)(nextElement, iframeWindow);
    var relativeAttr = _common__WEBPACK_IMPORTED_MODULE_10__.relativeElementTagAttrMap[nextElement.tagName];
    var url = nextElement[relativeAttr];
    if (relativeAttr) nextElement.setAttribute(relativeAttr, (0,_utils__WEBPACK_IMPORTED_MODULE_15__.getAbsolutePath)(url, nextElement.baseURI || ""));
    nextElement = ElementIterator.nextNode();
  }
...
function _renderTemplateToShadowRoot() {
  _renderTemplateToShadowRoot = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().mark(function _callee2(shadowRoot, iframeWindow, template) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          shade.setAttribute("style", _constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_SHADE_STYLE);
          ...
          (0,_effect__WEBPACK_IMPORTED_MODULE_13__.patchRenderEffect)(shadowRoot, iframeWindow.__WUJIE.id, false);
        case 12:
        case "end":
          return _context2.stop();
      }
...
function createIframeContainer(id) {
  ...
  var defaultStyle = "height:100%;width:100%";
  (0,_utils__WEBPACK_IMPORTED_MODULE_15__.setAttrsToElement)(iframe, _objectSpread(_objectSpread({}, degradeAttrs), {}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
    style: [defaultStyle, degradeAttrs.style].join(";")
  }, _constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_APP_ID, id)));
  return iframe;
}
...
function _renderTemplateToIframe() {
  _renderTemplateToIframe = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().mark(function _callee3(renderDocument, iframeWindow, template) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          (0,_effect__WEBPACK_IMPORTED_MODULE_13__.patchRenderEffect)(renderDocument, iframeWindow.__WUJIE.id, true);
        case 7:
        case "end":
...
function clearChild(root) {
  ...
  while (root !== null && root !== void 0 && root.firstChild) {
    _common__WEBPACK_IMPORTED_MODULE_10__.rawElementRemoveChild.call(root, root.firstChild);
  }
}
...
function addLoading(el, loading) {
  var container = (0,_utils__WEBPACK_IMPORTED_MODULE_15__.getContainer)(el);
  clearChild(container);
  ...
  if (containerStyles.position === "static") {
    container.setAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.CONTAINER_POSITION_DATA_FLAG, containerStyles.position);
    container.setAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.CONTAINER_OVERFLOW_DATA_FLAG, containerStyles.overflow === "visible" ? "" : containerStyles.overflow);
  ...
  loadingContainer.setAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.LOADING_DATA_FLAG, "");
  loadingContainer.setAttribute("style", _constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_LOADING_STYLE);
  if (loading) loadingContainer.appendChild(loading);else loadingContainer.innerHTML = _constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_LOADING_SVG;
...
function removeLoading(el) {
  // 去除容器设置的样式
  var positionFlag = el.getAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.CONTAINER_POSITION_DATA_FLAG);
  var overflowFlag = el.getAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.CONTAINER_OVERFLOW_DATA_FLAG);
  ...
  el.removeAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.CONTAINER_POSITION_DATA_FLAG);
  el.removeAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.CONTAINER_OVERFLOW_DATA_FLAG);
  var loadingContainer = el.querySelector("div[".concat(_constant__WEBPACK_IMPORTED_MODULE_9__.LOADING_DATA_FLAG, "]"));
...
/* harmony export */ });
/* harmony import */ var _typeof_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var _assertThisInitialized_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(42);
...
/* harmony export */ });
/* harmony import */ var _getPrototypeOf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
/* harmony import */ var _setPrototypeOf_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40);
/* harmony import */ var _isNativeFunction_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45);
/* harmony import */ var _construct_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);
...
/* harmony export */ });
/* harmony import */ var _setPrototypeOf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40);
/* harmony import */ var _isNativeReflectConstruct_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(47);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addSandboxCacheWithOptions: () => (/* binding */ addSandboxCacheWithOptions),
/* harmony export */   addSandboxCacheWithWujie: () => (/* binding */ addSandboxCacheWithWujie),
/* harmony export */   appDocumentAddEventListenerEvents: () => (/* binding */ appDocumentAddEventListenerEvents),
/* harmony export */   appDocumentOnEvents: () => (/* binding */ appDocumentOnEvents),
/* harmony export */   appWindowAddEventListenerEvents: () => (/* binding */ appWindowAddEventListenerEvents),
/* harmony export */   appWindowOnEvent: () => (/* binding */ appWindowOnEvent),
/* harmony export */   deleteWujieById: () => (/* binding */ deleteWujieById),
/* harmony export */   documentProxyProperties: () => (/* binding */ documentProxyProperties),
/* harmony export */   getOptionsById: () => (/* binding */ getOptionsById),
/* harmony export */   getWujieById: () => (/* binding */ getWujieById),
/* harmony export */   idToSandboxCacheMap: () => (/* binding */ idToSandboxCacheMap),
/* harmony export */   mainAndAppAddEventListenerEvents: () => (/* binding */ mainAndAppAddEventListenerEvents),
/* harmony export */   mainDocumentAddEventListenerEvents: () => (/* binding */ mainDocumentAddEventListenerEvents),
/* harmony export */   rawAddEventListener: () => (/* binding */ rawAddEventListener),
/* harmony export */   rawAppendChild: () => (/* binding */ rawAppendChild),
/* harmony export */   rawBodyInsertBefore: () => (/* binding */ rawBodyInsertBefore),
/* harmony export */   rawDocumentQuerySelector: () => (/* binding */ rawDocumentQuerySelector),
/* harmony export */   rawElementAppendChild: () => (/* binding */ rawElementAppendChild),
/* harmony export */   rawElementContains: () => (/* binding */ rawElementContains),
/* harmony export */   rawElementRemoveChild: () => (/* binding */ rawElementRemoveChild),
/* harmony export */   rawHeadInsertBefore: () => (/* binding */ rawHeadInsertBefore),
/* harmony export */   rawRemoveEventListener: () => (/* binding */ rawRemoveEventListener),
/* harmony export */   rawWindowAddEventListener: () => (/* binding */ rawWindowAddEventListener),
/* harmony export */   rawWindowRemoveEventListener: () => (/* binding */ rawWindowRemoveEventListener),
/* harmony export */   relativeElementTagAttrMap: () => (/* binding */ relativeElementTagAttrMap),
/* harmony export */   windowProxyProperties: () => (/* binding */ windowProxyProperties),
/* harmony export */   windowRegWhiteList: () => (/* binding */ windowRegWhiteList)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   patchRenderEffect: () => (/* binding */ patchRenderEffect),
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
/* harmony import */ var _entry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(19);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(48);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27);
/* harmony import */ var _iframe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(37);
/* harmony import */ var _shadow__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(38);
/* harmony import */ var _plugin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(29);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(28);
/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(20);
...
function manualInvokeElementEvent(element, event) {
  ...
  if ((0,_utils__WEBPACK_IMPORTED_MODULE_5__.isFunction)(element["on".concat(event)])) {
...
function handleStylesheetElementPatch(stylesheetElement, sandbox) {
  ...
  var patcher = function patcher() {
    var _getPatchStyleElement = (0,_shadow__WEBPACK_IMPORTED_MODULE_7__.getPatchStyleElements)([stylesheetElement.sheet]),
      _getPatchStyleElement2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_getPatchStyleElement, 2),
      hostStyleSheetElement = _getPatchStyleElement2[0],
      fontStyleSheetElement = _getPatchStyleElement2[1];
    if (hostStyleSheetElement) {
    ...
    appendChild: {
      value: function value(node) {
        ...
        if (node.nodeType === Node.TEXT_NODE) {
          var res = _common__WEBPACK_IMPORTED_MODULE_4__.rawAppendChild.call(stylesheetElement, stylesheetElement.ownerDocument.createTextNode(cssLoader(node.textContent, "", curUrl)));
          // 当appendChild之后，样式元素的sheet对象发生改变，要重新patch
          patchSheetInsertRule();
          return res;
        } else return (0,_common__WEBPACK_IMPORTED_MODULE_4__.rawAppendChild)(node);
      }
    },
    _hasPatchStyle: {
      get: function get() {
...
function rewriteAppendOrInsertChild(opts) {
  return function appendChildOrInsertBefore(newChild, refChild) {
    ...
    var sandbox = (0,_common__WEBPACK_IMPORTED_MODULE_4__.getWujieById)(wujieId);
    var styleSheetElements = sandbox.styleSheetElements,
      ...
      fiber = sandbox.fiber;
    if (!(0,_utils__WEBPACK_IMPORTED_MODULE_5__.isHijackingTag)(element.tagName) || !wujieId) {
      var res = rawDOMAppendOrInsertBefore.call(this, element, refChild);
      (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.patchElementEffect)(element, iframe.contentWindow);
      (0,_utils__WEBPACK_IMPORTED_MODULE_5__.execHooks)(plugins, "appendOrInsertElementHook", element, iframe.contentWindow);
      return res;
    }
    var iframeDocument = iframe.contentDocument;
    var curUrl = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getCurUrl)(proxyLocation);
    ...
    if (element.tagName) {
      ...
      switch ((_element$tagName = element.tagName) === null || _element$tagName === void 0 ? void 0 : _element$tagName.toUpperCase()) {
        case "LINK":
          {
            ...
            // 排除css
            if (href && !(0,_plugin__WEBPACK_IMPORTED_MODULE_8__.isMatchUrl)(href, (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.getEffectLoaders)("cssExcludes", plugins))) {
              (0,_entry__WEBPACK_IMPORTED_MODULE_3__.getExternalStyleSheets)([{
                src: href,
                ignore: (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.isMatchUrl)(href, (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.getEffectLoaders)("cssIgnores", plugins))
                ...
                return contentPromise.then(function (content) {
                  // 处理 ignore 样式
                  var rawAttrs = (0,_template__WEBPACK_IMPORTED_MODULE_10__.parseTagAttributes)(element.outerHTML);
                  if (ignore && src) {
                    ...
                    // 处理css-loader插件
                    var cssLoader = (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.getCssLoader)({
                      plugins: plugins,
                      replace: replace
                    });
                    stylesheetElement.innerHTML = cssLoader(content, src, curUrl);
                    styleSheetElements.push(stylesheetElement);
                    (0,_utils__WEBPACK_IMPORTED_MODULE_5__.setAttrsToElement)(stylesheetElement, rawAttrs);
        ...
        case "SCRIPT":
          {
            (0,_utils__WEBPACK_IMPORTED_MODULE_5__.setTagToScript)(element);
            var _ref3 = element,
              src = _ref3.src,
              text = _ref3.text,
              _type = _ref3.type,
            ...
            // 排除js
            if (src && !(0,_plugin__WEBPACK_IMPORTED_MODULE_8__.isMatchUrl)(src, (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.getEffectLoaders)("jsExcludes", plugins))) {
              var execScript = function execScript(scriptResult) {
                // 假如子应用被连续渲染两次，两次渲染会导致处理流程的交叉污染
                if (sandbox.iframe === null) return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.warn)(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_TIPS_REPEAT_RENDER);
              ...
              var scriptOptions = {
                ...
                ignore: (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.isMatchUrl)(src, (0,_plugin__WEBPACK_IMPORTED_MODULE_8__.getEffectLoaders)("jsIgnores", plugins)),
                attrs: (0,_template__WEBPACK_IMPORTED_MODULE_10__.parseTagAttributes)(element.outerHTML)
              };
              (0,_entry__WEBPACK_IMPORTED_MODULE_3__.getExternalScripts)([scriptOptions], fetch, lifecycles.loadError, fiber).forEach(function (scriptResult) {
                dynamicScriptExecStack = dynamicScriptExecStack.then(function () {
                  return scriptResult.contentPromise.then(function (content) {
                    var _sandbox$execQueue;
                    if (sandbox.execQueue === null) return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.warn)(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_TIPS_REPEAT_RENDER);
              ...
              sandbox.execQueue.push(function () {
                return fiber ? sandbox.requestIdleCallback(function () {
                  (0,_iframe__WEBPACK_IMPORTED_MODULE_6__.insertScriptToIframe)({
                    src: null,
                    content: text,
                    attrs: (0,_template__WEBPACK_IMPORTED_MODULE_10__.parseTagAttributes)(element.outerHTML)
                  }, sandbox.iframe.contentWindow, element);
        ...
        case "IFRAME":
          {
            ...
            if (element.getAttribute(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_DATA_FLAG) === "") {
              return _common__WEBPACK_IMPORTED_MODULE_4__.rawAppendChild.call(_common__WEBPACK_IMPORTED_MODULE_4__.rawDocumentQuerySelector.call(this.ownerDocument, "html"), element);
            }
...
function findScriptElementFromIframe(rawElement, wujieId) {
  var wujieTag = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getTagFromScript)(rawElement);
  var sandbox = (0,_common__WEBPACK_IMPORTED_MODULE_4__.getWujieById)(wujieId);
  var iframe = sandbox.iframe;
  var targetScript = iframe.contentWindow.__WUJIE_RAW_DOCUMENT_HEAD__.querySelector("script[".concat(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_SCRIPT_ID, "='").concat(wujieTag, "']"));
  if (targetScript === null) {
    (0,_utils__WEBPACK_IMPORTED_MODULE_5__.warn)(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_TIPS_NO_SCRIPT, "<script ".concat(_constant__WEBPACK_IMPORTED_MODULE_9__.WUJIE_SCRIPT_ID, "='").concat(wujieTag, "'/>"));
  }
  return {
...
function rewriteContains(opts) {
  return function contains(other) {
    ...
    var rawElementContains = opts.rawElementContains,
      wujieId = opts.wujieId;
    if (element && (0,_utils__WEBPACK_IMPORTED_MODULE_5__.isScriptElement)(element)) {
...
function patchEventListener(element) {
  ...
  element.addEventListener = function (type, listener, options) {
    ...
    listenerMap.set(type, [].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(listeners), [listener]));
    return _common__WEBPACK_IMPORTED_MODULE_4__.rawAddEventListener.call(element, type, listener, options);
  };
  element.removeEventListener = function (type, listener, options) {
    ...
    return _common__WEBPACK_IMPORTED_MODULE_4__.rawRemoveEventListener.call(element, type, listener, options);
  };
}
...
function removeEventListener(element) {
  ...
  (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(listenerMap.entries()).forEach(function (_ref4) {
    var _ref5 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_ref4, 2),
      type = _ref5[0],
      listeners = _ref5[1];
    listeners.forEach(function (listener) {
      return _common__WEBPACK_IMPORTED_MODULE_4__.rawRemoveEventListener.call(element, type, listener);
    });
  });
}
...
function patchRenderEffect(render, id, degrade) {
  ...
  render.head.appendChild = rewriteAppendOrInsertChild({
    rawDOMAppendOrInsertBefore: _common__WEBPACK_IMPORTED_MODULE_4__.rawAppendChild,
    wujieId: id
  });
  render.head.insertBefore = rewriteAppendOrInsertChild({
    rawDOMAppendOrInsertBefore: _common__WEBPACK_IMPORTED_MODULE_4__.rawHeadInsertBefore,
    wujieId: id
  });
  render.head.removeChild = rewriteRemoveChild({
    rawElementRemoveChild: _common__WEBPACK_IMPORTED_MODULE_4__.rawElementRemoveChild.bind(render.head),
    wujieId: id
  });
  render.head.contains = rewriteContains({
    rawElementContains: _common__WEBPACK_IMPORTED_MODULE_4__.rawElementContains.bind(render.head),
    wujieId: id
  });
  render.contains = rewriteContains({
    rawElementContains: _common__WEBPACK_IMPORTED_MODULE_4__.rawElementContains.bind(render),
    wujieId: id
  });
  ...
  render.body.insertBefore = rewriteAppendOrInsertChild({
    rawDOMAppendOrInsertBefore: _common__WEBPACK_IMPORTED_MODULE_4__.rawBodyInsertBefore,
    wujieId: id
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   clearInactiveAppUrl: () => (/* binding */ clearInactiveAppUrl),
/* harmony export */   processAppForHrefJump: () => (/* binding */ processAppForHrefJump),
/* harmony export */   pushUrlToWindow: () => (/* binding */ pushUrlToWindow),
/* harmony export */   syncUrlToIframe: () => (/* binding */ syncUrlToIframe),
/* harmony export */   syncUrlToWindow: () => (/* binding */ syncUrlToWindow)
/* harmony export */ });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
/* harmony import */ var _iframe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(37);
/* harmony import */ var _shadow__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(38);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48);
...
function syncUrlToWindow(iframeWindow) {
  ...
  var winUrlElement = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.anchorElementGenerator)(window.location.href);
  var queryMap = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.getAnchorElementQueryMap)(winUrlElement);
...
function syncUrlToIframe(iframeWindow) {
  ...
  // 只在浏览器刷新或者第一次渲染时同步
  var idUrl = sync && !execFlag ? (0,_utils__WEBPACK_IMPORTED_MODULE_0__.getSyncUrl)(id, prefix) : url;
  // 排除href跳转情况
  var syncUrl = (/^http/.test(idUrl) ? null : idUrl) || url;
  var _appRouteParse = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.appRouteParse)(syncUrl),
    appRoutePath = _appRouteParse.appRoutePath;
...
function clearInactiveAppUrl() {
  ...
  Object.keys(queryMap).forEach(function (id) {
    var sandbox = (0,_common__WEBPACK_IMPORTED_MODULE_3__.getWujieById)(id);
    if (!sandbox) return;
    // 子应用执行过并且已经失活才需要清除
...
function processAppForHrefJump() {
  window.addEventListener("popstate", function () {
    ...
    Object.keys(queryMap).map(function (id) {
      return (0,_common__WEBPACK_IMPORTED_MODULE_3__.getWujieById)(id);
    }).filter(function (sandbox) {
      return sandbox;
    }).forEach(function (sandbox) {
      var url = queryMap[sandbox.id];
      var iframeBody = _common__WEBPACK_IMPORTED_MODULE_3__.rawDocumentQuerySelector.call(sandbox.iframe.contentDocument, "body");
      // 前进href
      if (/http/.test(url)) {
        if (sandbox.degrade) {
          (0,_shadow__WEBPACK_IMPORTED_MODULE_2__.renderElementToContainer)(sandbox.document.documentElement, iframeBody);
          (0,_iframe__WEBPACK_IMPORTED_MODULE_1__.renderIframeReplaceApp)(window.decodeURIComponent(url), (0,_utils__WEBPACK_IMPORTED_MODULE_0__.getDegradeIframe)(sandbox.id).parentElement, sandbox.degradeAttrs);
        } else (0,_iframe__WEBPACK_IMPORTED_MODULE_1__.renderIframeReplaceApp)(window.decodeURIComponent(url), sandbox.shadowRoot.host.parentElement, sandbox.degradeAttrs);
        sandbox.hrefFlag = true;
        // href后退
      } else if (sandbox.hrefFlag) {
        if (sandbox.degrade) {
          // 走全套流程，但是事件恢复不需要
          var _initRenderIframeAndC = (0,_shadow__WEBPACK_IMPORTED_MODULE_2__.initRenderIframeAndContainer)(sandbox.id, sandbox.el, sandbox.degradeAttrs),
            iframe = _initRenderIframeAndC.iframe;
          (0,_iframe__WEBPACK_IMPORTED_MODULE_1__.patchEventTimeStamp)(iframe.contentWindow, sandbox.iframe.contentWindow);
          iframe.contentWindow.onunload = function () {
            sandbox.unmount();
          };
          iframe.contentDocument.appendChild(iframeBody.firstElementChild);
          sandbox.document = iframe.contentDocument;
        } else (0,_shadow__WEBPACK_IMPORTED_MODULE_2__.renderElementToContainer)(sandbox.shadowRoot.host, sandbox.el);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   localGenerator: () => (/* binding */ localGenerator),
/* harmony export */   proxyGenerator: () => (/* binding */ proxyGenerator)
/* harmony export */ });
/* harmony import */ var _iframe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(37);
/* harmony import */ var _shadow__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(38);
/* harmony import */ var _sync__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(50);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(28);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(27);
...
function locationHrefSet(iframe, value, appHostPath) {
  ...
  var url = value;
  if (!/^http/.test(url)) {
    var hrefElement = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.anchorElementGenerator)(url);
    url = appHostPath + hrefElement.pathname + hrefElement.search + hrefElement.hash;
    hrefElement = null;
  }
  iframe.contentWindow.__WUJIE.hrefFlag = true;
  if (degrade) {
    var iframeBody = _common__WEBPACK_IMPORTED_MODULE_3__.rawDocumentQuerySelector.call(iframe.contentDocument, "body");
    (0,_shadow__WEBPACK_IMPORTED_MODULE_1__.renderElementToContainer)(document.documentElement, iframeBody);
    (0,_iframe__WEBPACK_IMPORTED_MODULE_0__.renderIframeReplaceApp)(window.decodeURIComponent(url), (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getDegradeIframe)(id).parentElement, degradeAttrs);
  } else (0,_iframe__WEBPACK_IMPORTED_MODULE_0__.renderIframeReplaceApp)(url, shadowRoot.host.parentElement, degradeAttrs);
  (0,_sync__WEBPACK_IMPORTED_MODULE_2__.pushUrlToWindow)(id, url);
  return true;
}
...
function proxyGenerator(iframe, urlElement, mainHostPath, appHostPath) {
  var proxyWindow = new Proxy(iframe.contentWindow, {
    get: function get(target, p) {
      ...
      // 修正this指针指向
      return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getTargetValue)(target, p);
    },
    set: function set(target, p, value) {
      (0,_utils__WEBPACK_IMPORTED_MODULE_5__.checkProxyFunction)(value);
      target[p] = value;
      return true;
    },
  ...
  var proxyDocument = new Proxy({}, {
    get: function get(_fakeDocument, propKey) {
      ...
      if (!shadowRoot) (0,_utils__WEBPACK_IMPORTED_MODULE_5__.stopMainAppRun)();
      ...
      if (propKey === "createElement" || propKey === "createTextNode") {
        return new Proxy(document[propKey], {
          apply: function apply(_createElement, _ctx, args) {
            ...
            (0,_iframe__WEBPACK_IMPORTED_MODULE_0__.patchElementEffect)(element, iframe.contentWindow);
            return element;
          }
        });
      }
        ...
        return new Proxy(shadowRoot.querySelector, {
          ...
          apply: function apply(target, ctx, args) {
            ...
            try {
              ...
              (0,_utils__WEBPACK_IMPORTED_MODULE_5__.warn)(_constant__WEBPACK_IMPORTED_MODULE_4__.WUJIE_TIPS_GET_ELEMENT_BY_ID);
              return null;
            }
          }
        });
      ...
      var ownerProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.ownerProperties,
        shadowProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.shadowProperties,
        shadowMethods = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.shadowMethods,
        documentProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.documentProperties,
        documentMethods = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.documentMethods;
      ...
      if (shadowMethods.includes(propKey.toString())) {
        var _getTargetValue;
        return (_getTargetValue = (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getTargetValue)(shadowRoot, propKey)) !== null && _getTargetValue !== void 0 ? _getTargetValue : (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getTargetValue)(document, propKey);
      }
      ...
      if (documentMethods.includes(propKey.toString())) {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getTargetValue)(document, propKey);
      }
    }
  });
  ...
  var proxyLocation = new Proxy({}, {
    get: function get(_fakeLocation, propKey) {
      ...
      if (propKey === "reload") {
        (0,_utils__WEBPACK_IMPORTED_MODULE_5__.warn)(_constant__WEBPACK_IMPORTED_MODULE_4__.WUJIE_TIPS_RELOAD_DISABLED);
        return function () {
          return null;
        };
      }
      ...
      return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.getTargetValue)(location, propKey);
    },
...
function localGenerator(iframe, urlElement, mainHostPath, appHostPath) {
  ...
  // 普通处理
  var modifyLocalProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.modifyLocalProperties,
    modifyProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.modifyProperties,
    ownerProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.ownerProperties,
    shadowProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.shadowProperties,
    shadowMethods = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.shadowMethods,
    documentProperties = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.documentProperties,
    documentMethods = _common__WEBPACK_IMPORTED_MODULE_3__.documentProxyProperties.documentMethods;
  modifyProperties.filter(function (key) {
    ...
    Object.defineProperty(proxyDocument, key, {
      get: function get() {
        ...
        return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.isCallable)(value) ? value.bind(sandbox.document) : value;
      }
    });
  });
  ...
  locationKeys.filter(function (key) {
    ...
    Object.defineProperty(proxyLocation, key, {
      get: function get() {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_5__.isCallable)(location[key]) ? location[key].bind(location) : location[key];
      }
    });
  });
  return {
...
/* harmony export */   appEventObjMap: () => (/* binding */ appEventObjMap)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(35);
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27);
/* harmony import */ var _constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28);




// 全部事件存储map
var appEventObjMap = window.__POWERED_BY_WUJIE__ ? window.__WUJIE.inject.appEventObjMap : new Map();
...
var EventBus = /*#__PURE__*/function () {
  ...
  // 监听事件
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(EventBus, [{
    key: "$on",
    ...
    value: function $onAll(fn) {
      return this.$on(_constant__WEBPACK_IMPORTED_MODULE_3__.WUJIE_ALL_EVENT, fn);
    }
    ...
    value: function $off(event, fn) {
      ...
      if (!event || !cbs || !cbs.length) {
        (0,_utils__WEBPACK_IMPORTED_MODULE_2__.warn)("".concat(event, " ").concat(_constant__WEBPACK_IMPORTED_MODULE_3__.WUJIE_TIPS_NO_SUBJECT));
        return this;
      }
      var cb;
      var i = cbs.length;
    ...
    value: function $offAll(fn) {
      return this.$off(_constant__WEBPACK_IMPORTED_MODULE_3__.WUJIE_ALL_EVENT, fn);
    }
    ...
    value: function $emit(event) {
      ...
      appEventObjMap.forEach(function (eventObj) {
        ...
        if (eventObj[_constant__WEBPACK_IMPORTED_MODULE_3__.WUJIE_ALL_EVENT]) allCbs = allCbs.concat(eventObj[_constant__WEBPACK_IMPORTED_MODULE_3__.WUJIE_ALL_EVENT]);
      });
      if (!event || cbs.length === 0 && allCbs.length === 0) {
        ...
        try {
          ...
          (0,_utils__WEBPACK_IMPORTED_MODULE_2__.error)(e);
        }
      }
      return this;
    }
...
const wujie_1 = __webpack_require__(10);
