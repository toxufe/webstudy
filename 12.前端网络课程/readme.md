...
跟颜色相关的 会重发重绘  
 ...
 ### CPU 计算器组成原理
 硬件 冯诺依曼  
 ![](../source/img/2024-04-29-23-58-09.png)

 内部存储器  
 二进制代码的形式存储,以字节为单位,8位的一个字节。一个字节占用一个储存单元，每一个存储单元有一个唯一的地址号。  



## CDN
内容分发的意思，content deliver network  
作用：优化网络资源的一个请求时间  
...
### CDN 工作过程
![](../source/img/2024-04-30-00-10-15.png)

权威域名服务器，会发生变化，就找就近的DNS服务器。  
CNAME别名去寻找。  

### 负载均衡
![](../source/img/2024-04-30-00-12-09.png)

## 浏览器跨域
浏览器同源策略限制  
![](../source/img/2024-04-30-22-22-29.png)

### 解决跨域的问题
四个方法  
![](../source/img/2024-04-30-22-24-10.png)